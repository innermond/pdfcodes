...
- **Sursă fișier** — de unde iei fișierul:
  - **Fișier local** — câmpul **PDF sau SVG (opțional)** deschide selectorul de
    ...
    **Pagina (1–N)**. Când refolosești PDF-ul de fundal, aplicația alege automat
...
- **Redesenează (decalaj mm, + în afară / − în interior)** — decalează **întreaga
  ...
  diferit de 0, sub „Dimensiune” apare și rezultatul: *„După redesenare (+X mm):
  tăiere W × H mm”*.
...
Până atunci, sub pas apare mesajul galben *„Apasă «Generează CSV» în pasul «Date»
pentru a continua.”*.

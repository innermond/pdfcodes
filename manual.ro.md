...
- **Desenează cercurile de reglaj** — implicit, PDF-ul de contur **nu** conține
  cercurile de reglaj: ele sunt repere de poziționare pentru print, nu linii de
  tăiat, deci nu înseamnă nimic pentru cutter. Bifează opțiunea dacă le vrei
  totuși în conturul generat. În ambele cazuri așezarea rămâne identică (grila
  păstrează același spațiu la margini), deci printul și conturul se potrivesc în
  continuare; PDF-ul de print își păstrează propriile cercuri. Nu apare în
  „Non-decupare” (acolo nu există cercuri deloc).
